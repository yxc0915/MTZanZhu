...
public class CallbackServer {
    private final MTZanZhu plugin;
    private final HttpServer server;
    private final String vmqKey;
    private final Logger logger;

    public CallbackServer(MTZanZhu plugin, int port, String path, String vmqKey) throws IOException {
        this.plugin = plugin;
        this.vmqKey = vmqKey;
    ...
    private class CallbackHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            try {
                ...
                String calculatedSign = MTZanZhu.md5(payId + param + type + price + reallyPrice + vmqKey);
    ...
    private void processOrder(String payId, String param, String type, String price, String reallyPrice) {
        MTZanZhu.OrderInfo orderInfo = plugin.getOrderInfo(payId);
        if (orderInfo == null) {
        ...
        MTZanZhu.ProjectConfig project = orderInfo.getProject();
